...
class Insta
{
    ...
    private String password="2543";
    private long phno=9603727566l;
    void Insta(String username,String password,long phno)
    {
...
class User
{
    ...
    void signup()
    {
	System.out.println("Enter login details to create new account");
	...
	x=new User(username,password,phno);
	System.out.println("Account created successfully\n 1 for login or any key to exit");
	...
	public static void main(String[] args) 
	{
		...
		{
			System.out.println("Thank you press any key to retry");
			main(args);
		}
	}
}
